      ...
      <div class="row gy-4">
        <div class="col-lg-5 col-md-12 footer-info">
          ...
          <div class="social-links d-flex mt-4">
            ...
            <a href="https://www.youtube.com/@kaseps8304/videos" class="instagram"><i class="bi bi-instagram"></i></a>
            <a href="https://www.youtube.com/@kaseps8304/videos" class="linkedin"><i class="bi bi-linkedin"></i></a>
          </div>
        </div>
